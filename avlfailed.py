...
class AVL(BST):
    ...
    def add(self, value: object) -> None:
        ...
        After adding the new node, rebalance the tree.
        """
            ...
            while cur:
                ...
                if value < cur.value:
                    ...
                    # i.e. this new node will be the smallest in this subtree
                        ...
                        node.parent = cur
                        cur.left = node
                        # now the new node was added, we rebalance the tree
    ...
    def update_height(self, node):
        """
        This method updates all the nodes' heights of an AVL Tree.
        :return:
        """
        if node.left and node.right:
    ...
    def rebalance(self, node):
        """
        This method checks the AVL tree from the leaves using bfs,
        and rotate the nodes if the balance_factor is equal to 2 or -2.
        :return:
        """
        parent = node.parent
        if parent.left == node:
            target = node.parent.left
        else:
            target = node.parent.right
